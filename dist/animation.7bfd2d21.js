...
var swatches = document.querySelectorAll('.swatches img');
var gallery = document.querySelector('.photo-gallery');
var slides = document.querySelectorAll('.photo-gallery-container');
var currentSwatch = "1";
...
function setUpAnimation() {
  animateMainPage(); // pinningOnScroll()

  carooselAnimation();
}

function pinningOnScroll() {//    const tlIntro = gsap.timeline({
  //        ScrollTrigger: {
  //            trigger: '.main-page',
  //            start:'0%',
  //            end: '200%',
...
function animateMainPage() {
  tl.fromTo('.first-page', {
    ...
    borderRadius: "0rem",
    delay: 0.35,
    duration: 1.5 // ease:'elastic.out(1.5, 1)'
...
function carooselAnimation() {
  swatches.forEach(function (swatch, index) {
    var coord = slides[index].getBoundingClientRect().left;
    console.log(coord);
    swatch.addEventListener("click", function (e) {
      var swatchName = e.target.getAttribute('swatch');
